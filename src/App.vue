<template>
  <div>
    ...
    <div :style="'float: left; width:' + width + 'px; margin: 50px 100px; background-color: #FAF9F8; padding: 20px; height: 400px;'" v-chat-scroll="{infiniteScroll: infiniteScroll}">
      <div>
...
export default {
  ...
  methods: {
    infiniteScroll: function() {
      ...
      this.documents = this.documents.concat(this.documents)
    },
    send: function() {
      this.documents.push({
