<template>
  <div style="width: 300px; margin: 0 auto; background-color: #FAF9F8; padding: 20px;">
    ...
    <plain-text position="right" :document="{content: ''}"  date="08:32 PM"/>
    <plain-text position="left" :document="{content: ''}"  date="08:32 PM"/>
