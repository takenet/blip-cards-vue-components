  ...
  <div class="video-player-wrapper">
    ...
    <div :class="'video-player-controls ' + isFullScreen">
      ...
      <div class="video-player-bar">
        <div class="slider" ref="videoSlider">
          <div class="progress" ref="videoProgress">
      ...
      <div class='volume-control'>
        <span @click="setVolume()">
          <svg class="video-player-button player-button-left" width="24px" height="18px" viewBox="0 0 24 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="volume-slider-wrapper">
          <div class="volume-slider">
            <div class="slider" ref="volumeSlider">
              <div class="progress" ref="volumeProgress">
                <div class="pin" id="progress-pin"></div>
              </div>
            </div>
            <input class="video-player-volume" type="range" :value="this.currentTime" :max="this.totalTime" @input="setVideoAudio($event)" @change="setVideoAudio($event)">
          </div>
        </div>
      </div>
      <span @click="toogleFullScreen()">
        <svg class="video-player-button player-button-left" width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
export default {
  ...
  mounted: function () {
    ...
    this.slider = this.$refs.videoSlider
