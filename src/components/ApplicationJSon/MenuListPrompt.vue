          ...
          <div class="button-text text-center pointer">
            <div>
              <bds-icon
                name="list"
                theme="outline"
                class="menu-list-options-button-icon"
              ></bds-icon>
              <bds-typo
                variant="fs-16"
                bold="regular"
                line-height="simple"
                class="disable-selection menu-list-options-button-text typo"
                v-bind:class="{ readonly: readonly }"
              >
                {{ buttonText }}
              </bds-typo>
      ...
      <div class="form-group">
        ...
        <div>
          <textarea
            ...
            type="text"
            name="buttonText"
            :class="{ 'input-error': errors.has('buttonText') }"
            v-validate="'required'"
            class="form-control"
            v-auto-expand
            v-model="buttonText"
          ...
          <bds-typo
            ...
            class="help input-error"
            >{{ errors.first('buttonText') }}</bds-typo
          >
        </div>
      </div>
    </form>
